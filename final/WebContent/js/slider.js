...
Slider.prototype = {
  ...
  createElem: function (oParent) {
    ...
    for (var i = 0; i < this.settings.slider_num; i++) {
      imgStr += '<a href="javascript:;" class="slider-item" style=" background: url(images/banner/banner0'+(i + 1)+'.jpg) no-repeat center;background-size:1400px 505px;margin-top:27px"></a>';
